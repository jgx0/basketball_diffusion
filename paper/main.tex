...
from trajectory tensors, unaffected by either issue. Six unit tests cover
...
sampling-cost statement, not a model deficiency; the paired
branch-study mode that implements exactly this protocol ships with the
repository (\S\ref{sec:impl}). Accordingly, the released
